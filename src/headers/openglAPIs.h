#ifndef _INCLUDE_CROPENGLAPIS_H_
#define _INCLUDE_CROPENGLAPIS_H_
...
typedef void (APIETYP PGLVIEWPORT)(GLint x, GLint y, GLsizei width, GLsizei height);
typedef void (APIETYP PGLORTHO)(GLdouble left, GLdouble right, GLdouble bottom, GLdouble top, GLdouble zNear, GLdouble zFar);
